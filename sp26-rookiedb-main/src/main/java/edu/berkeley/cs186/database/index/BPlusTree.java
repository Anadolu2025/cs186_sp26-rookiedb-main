...
public class BPlusTree {
    ...
    public Iterator<RecordId> scanAll() {
        ...
        LeafNode mostleft=root.getLeftmostLeaf();
        return new BPlusTreeIterator(mostleft,mostleft.scanAll());
        //这里面的mostleft.scanAll()，是leafnode里面定义的函数，和scanall无关！！！
    ...
    public Iterator<RecordId> scanGreaterEqual(DataBox key) {
        ...
        // TODO(proj2): Return a BPlusTreeIterator.
        LeafNode theleaf=root.get(key);
        return new BPlusTreeIterator(theleaf,theleaf.scanGreaterEqual(key));
    }
    ...
    public void put(DataBox key, RecordId rid) {
        ...
        newchildren.add(oldRootPageNum);
        newchildren.add(splitpagenum);
    ...
    // Iterator ////////////////////////////////////////////////////////////////
    private class BPlusTreeIterator implements Iterator<RecordId> {//没有看懂这个定义是什么意思
        ...
        @Override
        public boolean hasNext() {//这个hasnext是和next一一对应的
            // TODO(proj2): implement
        ...
        public RecordId next() {
            // TODO(proj2): implement
            if(!hasNext()){//很巧妙，我刚才在想如果next也是和hasnext的结构一样，那么里面的currentLeaf，会不会打架啊
                //我一开始写的是currentIterator.hasNext() 是局部判断
                //BPlusTreeIterator.hasNext() or hasnext()是全局判断
